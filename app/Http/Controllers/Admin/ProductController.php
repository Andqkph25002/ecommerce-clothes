...
class ProductController extends Controller
{
    ...
    public function UpdateProductPhoto(Request $request)
    {
        ...
        if ($image_one) {
            ...
            Image::make($image_one)->resize(300, 300)->save('media/product/' .  $image_full_name);
            $data['image_one'] = 'media/product/' . $image_full_name;
        ...
        if ($image_two) {
            ...
            Image::make($image_two)->resize(300, 300)->save('media/product/' .  $image_full_name);
            $data['image_two'] = 'media/product/' . $image_full_name;
            $productimg = DB::table('products')->where('id', $id)->update($data);
            $notification = array(
        ...
        if ($image_three) {
            ...
            Image::make($image_three)->resize(300, 300)->save('media/product/' .  $image_full_name);
            $data['image_three'] = 'media/product/' . $image_full_name;
            $productimg = DB::table('products')->where('id', $id)->update($data);
            $notification = array(
