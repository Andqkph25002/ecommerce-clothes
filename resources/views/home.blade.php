...
<div class="contact-form">
    <div class="container">
        <div class="row">
            ...
            <div class="col-4">
                <div class="card">
                    <img src="{{ asset('frontend/images/man2.jpg') }}" style="height: 100px;width:100px;margin-left:34%;margin-top:20px" class="card-img-top">
                    <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                         ...
                         <div class="card-body">
                            ...
                            onclick="return confirm('Bạn có muốn đăng xuất ?')" class="btn btn-danger btn-sm btn-block">Logout</a>
                         </div>
                    </div>
                </div>
