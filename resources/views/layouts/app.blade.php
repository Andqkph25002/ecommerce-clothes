                    ...
                    <div class="col d-flex flex-row">
                        ...
                        <div class="top_bar_content ml-auto">
                                ...
                                <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            @else
                                            <li><a href="{{ route('language.vn') }}">Việt Nam</a></li>
                                            @endif
                            ...
                            <div class="top_bar_user">
                                ...
                                <div><a href="{{ route('login') }}"> <div class="user_icon"><img src="{{ asset('frontend/images/user.svg')}}" alt=""></div>Register/Sign in</a></div>
                                @else
                                <ul class="standard_dropdown top_bar_dropdown">
                                    <li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}">MIKENCO</a></div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="copyright_container d-flex flex-sm-row flex-column align-items-center justify-content-start">
                     ...
                     Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Đặng Quang Khánh An <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/profile.php?id=100025951390410" target="_blank">Mẫn</a>
