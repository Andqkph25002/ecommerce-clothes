                              ...
                              @foreach ($featured as $item)
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($item->image_one)}}" width="120" height="140" alt=""></div>
                                        <div class="product_content">
                                            ...
                                            <div class="product_extras">
                                                ...
                                                <button id="{{ $item->id }}" class="product_cart_button add_to_cart"
                                                    data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add to Cart</button>
                                            </div>
                                        </div>

                                         {{-- <a href="{{ URL::to('add/wishlist/' . $item->id) }}">
                                            <div class="product_fav"><i class="fas fa-heart"></i></div>
                                         </a> --}}
                                         <button class="add_to_wishlist" data-id="{{ $item->id }}">
                                            <div class="product_fav"><i class="fas fa-heart"></i></div>
                                         </button>
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    ...
                                    <div class="banner_2_text">{{ $item->brand_name }} <br>
                                        {{ $item->selling_price }}
                                    </div>
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img src="{{ asset($item->image_one)}}" height="500" width="200" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>          
...
@php
    ...
    $cat_id = $cats->id;
    $product = DB::table('products')->where('category_id' , $cat_id)->where('status' , 1)->orderBy('id' , 'desc')->limit(10)->get();
